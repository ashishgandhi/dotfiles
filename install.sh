...
# Install apps
brew install --cask appcleaner dash fantastical fork google-chrome google-drive iina kaleidoscope maestral netnewswire paw rectangle signal suspicious-package
