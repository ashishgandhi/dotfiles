...
# Install apps
brew install --cask appcleaner dash fork google-chrome iina intellij-idea iterm2 paw rectangle signal sublime-text suspicious-package visual-studio-code
